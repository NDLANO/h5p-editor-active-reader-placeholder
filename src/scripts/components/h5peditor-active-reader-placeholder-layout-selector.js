import './h5peditor-active-reader-placeholder-layout-selector.scss';
import LayoutTemplate from './h5peditor-active-reader-placeholder-layout-template.js';
...
export default class LayoutSelector {
  ...
  constructor(params = {}, callbacks = {}) {
    ...
    this.container.classList.add(
      'h5peditor-active-reader-placeholder-layout-selector'
    );
  ...
  addLayout(layout = {}) {
    ...
    layoutDOM.classList.add(
      'h5peditor-active-reader-placeholder-layout-selector-preview'
    );
  ...
  selectLayout(layoutId, reset = false) {
    ...
    if (this.layoutSelectedId) {
      this.layouts[this.layoutSelectedId].classList
        .remove('h5peditor-active-reader-placeholder-layout-selector-selected');
    }

    this.layoutSelectedId = layoutId;

    this.layouts[layoutId].classList
      .add('h5peditor-active-reader-placeholder-layout-selector-selected');
